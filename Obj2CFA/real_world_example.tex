...
we show that our technique can handle more real-world cases, namely {\em precision-critical} patterns~\cite{Li2018a}. %that our technique can handle
%where the examples belong to {\em precision-critical} patterns in~\cite{Li2018a}.
