...
\newcommand{\Zipper}{{\sc Zipper}}
\newcommand{\Data}{{\sc Data}}

\newcommand{\Insens}{{\it Insens}}
\newcommand{\Scaler}{{\sc Scaler}}
...
\newcommand{\afeat}{a}
\newcommand{\Methods}{{\it Mthd}}
\newcommand{\Invos}{{\mbi}}
\newcommand{\sem}[1]{[\![#1]\!]}
\newcommand{\mthd}{{{M}}}
\newcommand{\Program}{\mbp}
\newcommand{\selector}{S}
\newcommand{\component}{\mbc}
\newcommand{\comp}{c}
\newcommand{\idx}{j}
...
\newcommand{\tovar}{{\it to}}
\newcommand{\fromvar}{{\it from}}
\newcommand{\returnvar}{{\it return}}
\newcommand{\base}{{\it base}}
...
\newcommand{\Load}{\textit{FldLoad}}
\newcommand{\Store}{\textit{FldStore}}
%\newcommand{\Call}{\textsc{Call}}
\newcommand{\VCall}{\textit{Call}}
...
\newcommand{\VarPointsTo}{\textit{VarPtsTo}}
...
\newcommand{\myparagraph}[1]{\paragraph{\fontshape{\itdefault}\fontseries{\bfdefault}\selectfont #1\/}}
...
\newcommand{\Inst}{{\it Label}}
\newcommand{\Invo}{{\it Invo}}
\newcommand{\inst}{l}
\newcommand{\fix}{{\it fix}}
\newcommand{\entry}{{\it main}}
...
\newcommand{\weakupdate}{\stackrel {{\it weak}}{\mapsto}}

\newcommand{\ptsto}{X}
\newcommand{\reachable}{R}
\newcommand{\callgraph}{G}

\newcommand{\mthdof}{{\it Mthdof}}
